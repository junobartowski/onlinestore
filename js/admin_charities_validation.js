...
function loadGrid(url) {
    jQuery("#jqgrid").jqGrid({
        ...
        datatype: "json",
        height: '250',
        colNames: ['Name', 'Website', 'Facebook', 'Twitter', 'Table ID','Status', 'Action'],
        colModel: [
            {name: 'Name', index: 'Name', align: "left", sortable: true},
            {name: 'Website', index: 'Website', align: "left", sortable: true},
            {name: 'FacebookPage', index: 'FacebookPage', align: "left", sortable: true},
            {name: 'TwitterPage', index: 'TwitterPage', align: "left", sortable: true},
            {name: 'ID', index: 'ID', align: "left", sortable: true},
            {name: 'Status', index: 'Status', align: "center", sortable: true},
            {name: 'Action', index: 'Action', align: "center", sortable: true},
        ],
        rowNum: 10,
