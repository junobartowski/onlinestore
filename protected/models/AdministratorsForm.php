...
class AdministratorsForm extends CFormModel {
    ...
    public function signUp($firstName, $lastName, $sex, $countryCode, $postCode, $emailAddress, $mobileNumber, $username, $encryptedPassword, $activationCode) {
        ...
        $queryAccounts = "INSERT INTO administrators (Username, Password, AccountTypeID, Status, CreatedByAccountID, ActivationCode)
        ...
        try {
            ...
            $queryAccountDetails = "INSERT INTO administratordetails(AccountID, FirstName, LastName, Sex, EmailAddress, MobileNumber, CountryCode, PostCode)
...
//End of ajax live checking
    public function isUsernameExisting($username) {
        $connection = $this->_connection;
        $sql = "SELECT COUNT(ID) ctrID FROM administrators WHERE Username = :username";
        $command = $connection->createCommand($sql);
        $command->bindValues(array(":username" => $username));
        $result = $command->queryRow();
    ...
    public function getAdministratorPasswordByEmailAddress($emailAddress) {
        ...
        $connection = $this->_connection;
        $sql = "SELECT a.Password FROM administrators a
    ...
    public function getAccountIDByEmailAddressAndPassword($emailAddress, $encryptedPassword) {
        $connection = $this->_connection;
        $sql = "SELECT a.ID FROM administrators a
    ...
    public function getAccountIDANDAccountTypeIDAndStatusByEmailAddressAndPassword($emailAddress, $encryptedPassword) {
        $connection = $this->_connection;
        $sql = "SELECT a.ID, a.AccountTypeID, a.Status FROM administrators a
        		INNER JOIN administratordetails ad ON ad.AccountID = a.ID WHERE ad.EmailAddress = :emailAddress AND a.Password = :encryptedPassword";
        $command = $connection->createCommand($sql);
        $command->bindValues(array(":emailAddress" => $emailAddress, ":encryptedPassword" => $encryptedPassword));
        $result = $command->queryRow();
    ...
    public function getAccountIDByUsernameAndPassword($username, $encryptedPassword) {
        $connection = $this->_connection;
        $sql = "SELECT ID FROM administrators WHERE Username = :username AND Password = :encryptedPassword";
        $command = $connection->createCommand($sql);
    ...
    public function getAccountTypeIDByID($accountID) {
        $connection = $this->_connection;
        $sql = "SELECT AccountTypeID FROM administrators WHERE ID = :accountID";
        $command = $connection->createCommand($sql);
    ...
    public function getAccountTypeIDByIDWithActiveStatus($accountID) {
        $connection = $this->_connection;
        $sql = "SELECT AccountTypeID FROM administrators WHERE ID = :accountID AND Status = 1";
        $command = $connection->createCommand($sql);
        $command->bindValues(array(":accountID" => $accountID));
        $result = $command->queryRow();
    ...
    public function getAccountIDAndAccountTypeIDAndStatusByUsernameAndPassword($username, $encryptedPassword) {
        $connection = $this->_connection;
        $sql = "SELECT ID, AccountTypeID, Status FROM administrators WHERE Username = :username AND Password = :encryptedPassword";
        $command = $connection->createCommand($sql);
        $command->bindValues(array(":username" => $username, ":encryptedPassword" => $encryptedPassword));
        $result = $command->queryRow();
    ...
    public function activateAccount($accountID, $activatedByID) {
        ...
        $connection = $this->_connection;
        $beginTrans = $connection->beginTransaction();
        $sql = "UPDATE administrators SET Status = :status, DateActivated = NOW(), ActivatedByID = :activatedByID, ActivationAttempts = :activationAttempts WHERE ID = :accountID";
        $command = $connection->createCommand($sql);
    ...
    public function getActivationAttemptsByAccountID($accountID) {
        $connection = $this->_connection;
        $sql = "SELECT ActivationAttempts FROM administrators WHERE ID = :accountID";
        $command = $connection->createCommand($sql);
        $command->bindValues(array(":accountID" => $accountID));
        $result = $command->queryRow();
    ...
    public function getActivationCodeByAccountID($accountID) {
        $connection = $this->_connection;
        $sql = "SELECT ActivationCode FROM administrators WHERE ID = :accountID";
        $command = $connection->createCommand($sql);
        $command->bindValues(array(":accountID" => $accountID));
        $result = $command->queryRow();
    ...
    public function updateActivationAttempts($accountID) {
        ...
        $sql = "UPDATE administrators SET ActivationAttempts = :activationAttempts WHERE ID = :accountID";
        $command = $connection->createCommand($sql);
    ...
    public function lockAccountByAccount($accountID, $accountTypeID) {
        ...
        $connection = $this->_connection;
        $beginTrans = $connection->beginTransaction();
        $sql = "UPDATE administrators SET Status = :status WHERE ID = :accountID";
        $command = $connection->createCommand($sql);
