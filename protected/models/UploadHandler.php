...
/*
 * Description: UploadHandler Class
 * @author: JunJun S. Hernandez <hernandezjunjun28@gmail.com> (Modify only)
...
class UploadHandler {
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url() . '/images/uploads/items/' . Yii::app()->session['itemsFolderName'] . '/',
            'upload_dir' => $this->getCUrrentURL() . '/images/uploads/items/' . Yii::app()->session['itemsFolderName'] . '/',
            'upload_url' => $this->get_full_url() . '/images/uploads/items/' . Yii::app()->session['itemsFolderName'] . '/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
